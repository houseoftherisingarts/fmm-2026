...
# Project: FMM 2026 — Festival Médiéval de Montpellier
...
4. Report in one line: `"Vexel online. FMM 2026 — [honest status]."`

**Project context:** Festival Médiéval de Montpellier, édition 2026 "Caravanes et Saltimbanques". Sept 25–27. Alex wears double hat: Master Web + Master Nourriture. Critical: Zeffy ticket URLs not yet set in .env.local — no revenue until done.
