...
const PAIRS = [
  ['/', '/en', {
    ...
    en: { title: 'Festival Médiéval de Montpellier — Medieval Festival 2026 (Québec)',
      ...
      body: `${FAITS_EN}<p>Three festival days: AMQ mounted jousting, Viking combat, Viking camp, peasant village (forge, herbalism), artisan market, Equinox banquet, giant puppet, aerial dance and nine bands on stage: Skarazula, L'Harfang, Troupe Caravane, the Sainte-Nigoune Klezmer Ensemble, BicOasis, Trifolys, Svarica, Las Noches Bohemias and Alhambra.</p>` },
  }],
  ['/activites', '/en/activities', {
    fr: { title: 'Programmation 2026 — Festival Médiéval de Montpellier',
      desc: "Horaire complet des trois jours : joutes AMQ, combats vikings, démonstrations du village paysan, spectacles, banquet de l'Équinoxe et section jeunesse.",
      h1: 'Programmation 2026',
      body: `${FAITS_FR}<p>Au programme : joutes équestres et Chevaliers de l'Association Médiévale du Québec (AMQ), combats vikings dans l'arène, démonstrations de forge et parcours d'herboristerie au village paysan, conférence bohème, marionnette géante, danse aérienne, hobby horse, concours culinaire au camp viking, allumage du feu, spectacles de Skarazula, Harfang, Trifolys et Svarica, banquet de l'Équinoxe et section jeunesse présentée par Les Camps Légendaires. Portes : vendredi 17 h, samedi et dimanche 10 h.</p>` },
    en: { title: 'Program 2026 — Montpellier Medieval Festival (Québec)',
      desc: 'Full three-day schedule: AMQ jousting, Viking combat, peasant-village demonstrations, shows, Equinox banquet and youth section.',
      h1: 'Program 2026',
      body: `${FAITS_EN}<p>On the program: mounted jousting and Knights by the Association Médiévale du Québec (AMQ), Viking combat in the arena, forge demonstrations and herbalism trail in the peasant village, bohemian talk, giant puppet, aerial dance, hobby horse tournament, Viking-camp cooking contest, fire lighting, shows by Skarazula, Harfang, Trifolys and Svarica, the Equinox banquet and a youth section presented by Les Camps Légendaires. Gates: Friday 5 p.m., Saturday and Sunday 10 a.m.</p>` },
  }],
  ['/billets', '/en/tickets', {
  ...
  ['/marche', '/en/market', {
    fr: { title: 'Marché & Village — Festival Médiéval de Montpellier 2026',
      desc: "Une cinquantaine d'artisans et marchands d'époque, village gustatif, banquet de l'Équinoxe et cuisines de clans.",
      h1: 'Le Village & le Marché',
      body: `${FAITS_FR}<p>Le marché réunit une cinquantaine d'artisans et marchands d'époque : forgerons, costumiers, bijoutiers, brasseurs et herboristes. Le village gustatif sert des plats d'inspiration médiévale toute la fin de semaine, et le banquet de l'Équinoxe se réserve séparément des billets d'entrée.</p>` },
    en: { title: 'Market & Village — Montpellier Medieval Festival 2026',
      desc: 'Some fifty period artisans and merchants, food village, Equinox banquet and clan kitchens.',
      h1: 'The Village & Market',
      body: `${FAITS_EN}<p>The market gathers some fifty period artisans and merchants: smiths, costumers, jewellers, brewers and herbalists. The food village serves medieval-inspired dishes all weekend, and the Equinox banquet is booked separately from entry tickets.</p>` },
  }],
