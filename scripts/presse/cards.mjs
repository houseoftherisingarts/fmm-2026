...
export const CARDS = [
  ...
  },
  {
    ...
    fr: {
      ...
      body: 'Les artisans-démonstrateurs forgent, fondent le métal, gravent l’os et planent le bois devant vous, en expliquant chaque geste hérité d’une époque où la matière se travaillait à la main.',
      meta: 'Village paysan · démonstrations',
    },
    en: {
      kicker: 'The forge',
      hook: 'Iron worked before your eyes',
      body: 'The demonstrator-artisans forge, cast metal, engrave bone and plane wood in front of you, explaining every gesture handed down from an age when matter was shaped by hand.',
  ...
  },
  {
    ...
    fr: {
      ...
      body: 'L’hypocras de l’aubergiste coule au souper et l’animation continue pendant le repas. Autour, le village gustatif ouvre ses cuisines de clans et sa table d’hôte.',
      meta: 'Banquet médiéval · prix à venir',
    },
    en: {
      kicker: 'The banquet',
      hook: 'Supper served by torchlight',
      body: 'The innkeeper’s hypocras flows at supper and the entertainment carries on through the meal. Around it, the food village opens its clan kitchens and its table d’hôte.',
  ...
  },
  {
    ...
    fr: {
      ...
      body: 'Le village jeunesse ouvre ses ateliers d’écuyer et ses jeux d’adresse, avec des contes et une initiation au combat de mousse. Le gardiennage y est encadré, les parents peuvent aller voir la joute.',
      meta: 'Village jeunesse · trois jours',
    },
    en: {
      kicker: 'Youth village',
      hook: 'A camp for young lords',
      body: 'The youth village opens its squire workshops and its skill games, with tales and a foam-combat introduction. Babysitting is supervised, so parents can go watch the joust.',
