...
export const PILLAR_COPY: Record<PillarKey, { FR: PillarCopy; EN: PillarCopy }> = {
  ...
  histoire:    { FR: { eyebrow: 'Notre histoire',       title: '6 Ans d\'histoire',     lead: 'Six éditions, des milliers de visiteurs, des centaines de photos.' }, EN: { eyebrow: 'Our story',           title: '6 Years of History',    lead: 'Six editions, thousands of visitors, hundreds of photos.' } },
