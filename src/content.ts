...
export const PILLAR_COPY: Record<PillarKey, { FR: PillarCopy; EN: PillarCopy }> = {
  ...
  hebergement: { FR: { eyebrow: 'Sur place et alentours', title: 'Camping & Hébergement', lead: 'Plantez votre tente ou votre roulotte sur le site du festival, ou choisissez une adresse où dormir dans la Petite-Nation.' }, EN: { eyebrow: 'On site and nearby',  title: 'Camping & Lodging',     lead: 'Pitch your tent or park your camper on the festival grounds, or pick a place to sleep across Petite-Nation.' } },
