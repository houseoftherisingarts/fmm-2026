...
const TOUTES: Annonce[] = [
  ...
  // politique d'annulation comme partout où une place se vend.
  {
    ...
    bodyFR:
      'Il n’y a qu’un seul banquet de toute la fin de semaine, et il se tient le dimanche 27 septembre à treize heures trente, au Village Nourriture. Si vous avez réservé vos places plus tôt cet été, votre reçu porte peut-être encore l’ancien nom du repas, le Banquet de l’Équinoxe, avec la date du jour où vous avez payé : c’est le même banquet, et vos places vous attendent à la grande table le dimanche. Il reste encore des places parmi les cinquante, à 65 $ plus taxes pour les trois services, et elles se réservent sur la page Nourriture. '
      + POLITIQUE_ANNULATION.courteFR,
    bodyEN:
      'There is only one banquet all weekend, and it is held on Sunday 27 September at half past one, in the Food Village. If you booked your seats earlier this summer, your receipt may still carry the meal’s former name, the Equinox Banquet, along with the date you paid: it is the same banquet, and your seats are waiting at the long table on Sunday. There are still seats left among the fifty, at $65 plus tax for the three courses, and they can be booked on the Food page. '
