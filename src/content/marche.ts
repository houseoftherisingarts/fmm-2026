...
export const MARCHE_VENDORS: MarcheKiosk[] = [
  ...
  { id: 'corpsage',          name: 'CorpSage',              tier: 'marche', contact: 'Salomé Brassard', email: 'corpsage@example.ca',     category: 'Soins corps',  tagFR: '« Tatouage » au henné',                 tagEN: 'Henna "tattooing"',                   bioFR: 'Henné naturel et motifs corporels éphémères.', bioEN: 'Natural henna and ephemeral body designs.', href: 'https://corpsage.com/', image: '/wix/marche/2de271eb.jpg' , years: [2025] },
  ...
  { id: 'isabelle-jewelry',  name: 'Isabelle Jewelery',     tier: 'marche', contact: 'Isabelle Vachon',  email: 'isabelle@jewelry.example.ca', category: 'Bijoux',     tagFR: 'Bijoux faits main',                     tagEN: 'Handmade jewellery',                  bioFR: 'Bijoux en argent, cuivre et laiton, pièces uniques.', bioEN: 'Silver, copper and brass jewellery, one-off pieces.', image: '/wix/marche/3efa78c8.jpg' , years: [2025] },
