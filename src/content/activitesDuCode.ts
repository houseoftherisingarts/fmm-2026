...
const BRUT: Array<Omit<FicheInput, 'ordre'>> = [
  { titreFR: 'Escrime',          titreEN: 'Fencing',           sousTitreFR: 'et autres combats',                                       sousTitreEN: 'and other combat arts',
    ...
    image: '/activites/webp/combat-epee-bouclier.webp', categorie: 'combat' },
  ...
  { titreFR: 'Espace Jeunesse',  titreEN: 'Youth Space',       sousTitreFR: 'Parc, jeux, animations, gardiennage',                     sousTitreEN: 'Park, games, activities, supervision',
    ...
    image: '/activites/webp/enfants-jeu.webp', categorie: 'family' },
  ...
  { titreFR: 'Boustifaille',     titreEN: 'Feast',             sousTitreFR: 'La becquetance et la ripaille avec le nouveau village gustatif', sousTitreEN: 'Eating and feasting at the new food village',
    descFR: 'Le nouveau village gustatif : cuisines de clans, table d’hôte, banquet du Prince William. Cochon de lait, pain plat, ragoûts, pâtisseries d’époque. La becquetance et la ripaille, comme nous les aimons.',
    descEN: 'The new food village: clan kitchens, table d’hôte, Prince William banquet. Suckling pig, flatbread, stews, period pastries. Feasting and merrymaking as we love it.',
    image: '/activites/webp/table-victuailles.webp', categorie: 'ripaille' },
  { titreFR: 'Clinique Équestre',titreEN: 'Equestrian Clinic', sousTitreFR: 'Prochaine édition',                                        sousTitreEN: 'Next edition',
    ...
    image: '/activites/webp/cavaliere-chevaux.webp', categorie: 'family', retiree: true },
