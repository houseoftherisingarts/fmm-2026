...
// Where the email copy lands. Override with VITE_BUG_REPORT_EMAIL;
// defaults to the festival admin mailbox.
const NOTIFY_TO = import.meta.env.VITE_BUG_REPORT_EMAIL
