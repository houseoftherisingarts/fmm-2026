...
export const CATALOGUE: Objet[] = [
  ...
  { id: 'casque_heaume', nom: { FR: 'Heaume du gardien', EN: "Guardian's greathelm" }, emplacement: 'tete', bonus: { force: 3, endurance: 2 }, rarete: 'legendaire', couleur: '#D8B05A', variante: 3, source: 'trouvaille' },
  ...
  { id: 'casque_couronne_parrain', nom: { FR: 'Couronne du Parrain', EN: "Godfather's crown" }, emplacement: 'tete', bonus: {}, rarete: 'legendaire', couleur: '#D8B05A', variante: 5, source: 'badge', badgeId: 'le-parrain' },
  ...
  { id: 'torse_plates', nom: { FR: 'Plates du chevalier', EN: "Knight's plate" }, emplacement: 'torse', bonus: { force: 4, endurance: 3 }, rarete: 'legendaire', couleur: '#C9A85A', variante: 3, source: 'trouvaille' },
  ...
  { id: 'bottes_ailees', nom: { FR: 'Bottes ailées', EN: 'Winged boots' }, emplacement: 'pieds', bonus: { verve: 2, chance: 1 }, rarete: 'legendaire', couleur: '#C9A85A', variante: 3, source: 'trouvaille' },
  // Armes (main droite)
  ...
  { id: 'baton', nom: { FR: 'Bâton du sage', EN: "Sage's staff" }, emplacement: 'mainDroite', bonus: { ruse: 3, chance: 1 }, rarete: 'legendaire', couleur: '#D8B05A', variante: 3, source: 'trouvaille' },
  ...
  // Anneau
  { id: 'anneau_brume', nom: { FR: 'Anneau de brume', EN: 'Mist ring' }, emplacement: 'anneau', bonus: { ruse: 2 }, rarete: 'rare', couleur: '#D8B05A', variante: 1, source: 'trouvaille' },
];
