...
export const Motes: React.FC<{
  ...
  useEffect(() => {
    // 🚨 On n'écoute PAS prefers-reduced-motion (décision d'Alex,
    // 2026-08-02). Avant, le composant sortait aussitôt si le réglage
    // système était actif et le canevas restait vide à 300x150 :
    // personne avec « réduire les animations » ne voyait la moindre
    // particule, sur aucune page du site. La dérive est lente et
    // ambiante, donc elle reste supportable.
