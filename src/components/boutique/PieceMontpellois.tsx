...
// `image` bascule sur la gravure /montpellois.webp (déposée par Alex)
// pour les grands affichages, avec repli réel sur le SVG si le fichier
// ne charge pas (Alex, 2026-08-28).
...
const SVG: React.FC<{ size: number; className?: string }> = ({ size, className }) => (
