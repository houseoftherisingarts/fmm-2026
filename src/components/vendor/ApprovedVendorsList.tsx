...
// ─── NoticeBoard — vrai panneau de bois ──────────────────────────
// Le cadre vit dans border-image (coins ferrés nets), l'intérieur est
// la tuile de bois répétée. Rien n'est étiré, quelle que soit la taille.
const NoticeBoard: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <div className="relative max-w-5xl mx-auto">
    ...
    >
      ...
      />
      <div className="relative grid gap-x-6 gap-y-9 sm:grid-cols-2 lg:grid-cols-3 p-5 md:p-8">
        {children}
      </div>
    </div>
  </div>
