...
const FR = {
  ...
  festival: {
    ...
    cardBody: 'Depuis plus de 4 ans, le FMM ouvre un terrain où la résilience, l’histoire et l’esprit du temps se rencontrent.',
    cardCta: 'Lire',
  },
  explorerActivites: 'Enfilez votre tunique ou votre curiosité, et entrez dans le monde des Vikings, celui de la mer, de la terre et des étoiles.',
  explorerActivitesCta: 'Voir les activités',
  explorerHistoire: 'En quatre ans, des dizaines de troupes et des milliers de visiteurs sont passés par un site qui grandit d’édition en édition. Nos archives sont ouvertes.',
  explorerHistoireCta: 'Voir l’histoire',
  nouveautes: {
    title: 'Nouveautés 2026',
    cards: [
      { title: 'Village Nourriture',   eyebrow: 'Nouveau Banquet du Valhalla', body: 'Un menu élargi et renouvelé, à boire comme à manger.', image: '/wix/home/bonfire-warm.jpg', href: '/nourriture', cta: 'Voir les menus' },
      ...
      { title: 'Nouvelles Animations', eyebrow: 'De nouveaux spectacles et +', body: 'Cette année, nous ajoutons des animations, des troupes, des attractions et de la musique, avec ses chorégraphies et ses cérémonies.', image: '/wix/home/fire-night.jpg', href: '/activites', cta: 'Détails' },
    ],
  },
  editorial: {
  ...
  crosspromo: {
    hebergement:    'La Petite-Nation compte des auberges, des gîtes et des campings aux alentours du site.',
...
const EN = {
  ...
  festival: {
    ...
    cardBody: 'For over 4 years FMM has opened a ground where resilience, history and the spirit of the times come together.',
    cardCta: 'Read on',
  },
  explorerActivites: 'Slip on your tunic (or your curiosity) and step into the world of the Vikings, the one of sea, earth and stars.',
  explorerActivitesCta: 'See activities',
  explorerHistoire: 'In four years, dozens of troupes and thousands of visitors have passed through a site that grows edition by edition. Our archives are open.',
  explorerHistoireCta: 'See the history',
  nouveautes: {
    title: 'New for 2026',
    cards: [
      { title: 'Food Village',      eyebrow: 'New Valhalla banquet',   body: 'An expanded, renewed menu, for drinking as much as for eating.',                                          image: '/wix/home/bonfire-warm.jpg', href: '/en/food',    cta: 'See the menus' },
  ...
  crosspromo: {
    hebergement: 'Petite-Nation has inns, B&Bs and campgrounds around the site.', hebergementCta: 'Stay over',
