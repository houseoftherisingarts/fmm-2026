...
const FEATURED = [
  ...
  },
  {
    ...
    bioFR: 'Depuis la première itération, Le Groupe Gagnon est un de nos partenaires les plus fidèles et les plus généreux, et cette année, c’est lui qui présente la joute équestre dans l’arène. Nous sommes fiers d’acheter local, et ils sont fiers de commanditer local.',
    bioEN: 'Since the very first edition, Groupe Gagnon has been one of our most loyal and generous partners, and this year they present the mounted joust in the arena. We are proud to buy local, and they are proud to sponsor local.',
    href: '#TODO_groupe-gagnon',
    cta: { FR: 'Quincaillerie', EN: 'Hardware store' },
  },
  {
    name: 'MRC Papineau',
    image: '/wix/partenaires/panel-mrc.jpg',
    band: true,
    bioFR: 'La MRC de Papineau soutient le FMM comme elle soutient bien d’autres initiatives de la région, et leur site donne la mesure de tout ce qu’elle porte.',
    bioEN: 'MRC Papineau supports FMM the way it supports many other initiatives across the region, and their site shows the full breadth of what they carry.',
