...
const SHOWCASE_ITEMS: ShowcaseItem[] = [
  ...
  },
  {
    ...
    bodyFR: 'Six éditions ont fait passer des milliers de visiteurs, et il en reste des centaines de photos. Notre histoire et l’équipe qui la porte.',
    bodyEN: 'Six editions have brought thousands of visitors, and hundreds of photos remain. Our story and the team behind it.',
    ctaFR: 'Plonger dans les archives', ctaEN: 'Step into the archives',
    leftFR: '10 · 6 ans d’histoire',    leftEN: '10 · 6 years of history',
  ...
  },
  {
    ...
    bodyFR: 'Médiéval, païen, viking, celte ou laïc : célébrez votre union sur le terrain du festival. Demande pour 2026 ouverte.',
    bodyEN: 'Medieval, pagan, viking, Celtic or secular: celebrate your union on the festival grounds. 2026 inquiries open.',
...
const FR = {
  ...
  subtitle: 'Des caravanes nomades rejoignent les vikings et les chevaliers, avec une zone jeunesse, un village nourriture, du tarot, des tambours et des troupes nordiques. La sixième édition se joue au feu et au mystère, dans les montagnes du Québec.',
...
const EN = {
  ...
  subtitle: 'Nomadic caravans join the vikings and the knights, with a youth village, a food village, tarot, drums and Nordic troupes. The sixth edition runs on fire and mystery, in the mountains of Quebec.',
