...
const ANNEES: Annee[] = [
  {
    ...
    texteFR: 'Les portes restent closes et, dans la taverne, il ne reste que trois dés pour passer le temps. Deux chouettes, puis le cul : une chouette vaut le carré de sa face, un cul de chouette quarante plus dix fois la sienne, et le premier à trois cent quarante-trois points gagne la table. Le jeu de dés de Kaamelott, avec ses cris, ses paris et ses défis.',
    texteEN: 'The doors stay shut and, in the tavern, only three dice are left to pass the time. Two chouettes, then the cul: a chouette is worth the square of its face, a cul de chouette forty plus ten times its own, and the first to three hundred and forty-three points wins the table. The dice game from Kaamelott, with its shouts, its bets and its challenges.',
    jeuFR: 'Le Cul de chouette', jeuEN: 'Cul de chouette',
    image: '/jeux/tuile-chouette.webp',
    href: { fr: '/jeux/chouette', en: '/en/games/cul-de-chouette' },
  },
  {
    id: 'seigneur',
    chiffre: 'II',
    nomFR: 'L’année du Seigneur', nomEN: 'The Year of the Lord',
    texteFR: 'Le seigneur prend sa dîme, tient son donjon et fait asseoir ses gens à la table haute. Sur cette table se joue la mérelle, le jeu des moulins : neuf pions chacun, trois carrés emboîtés, et chaque alignement de trois enlève une pièce à l’autre. Contre l’ordinateur ou à deux sur le même écran.',
    texteEN: 'The lord takes his tithe, holds his keep and seats his people at the high table. On that table, merels is played, the mill game: nine pieces each, three nested squares, and every line of three takes a piece from the other side. Against the computer or with two players on one screen.',
