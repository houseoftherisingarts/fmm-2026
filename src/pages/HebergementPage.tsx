...
const FR = {
  ...
  lodgingLead:    'Auberges, campings et gîtes des environs. Utilisez les chevrons (ou ← →) pour parcourir le bestiaire.',
  lodging:        'Hébergement',
  prev:           'Précédent',
  next:           'Suivant',
  book:           'Voir le site',
...
const EN: typeof FR = {
  ...
  lodgingLead:    'Inns, campgrounds and B&Bs nearby. Use the chevrons (or ← →) to browse the bestiary.',
  lodging:        'Lodging',
  prev:           'Previous',
  next:           'Next',
