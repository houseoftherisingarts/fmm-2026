...
const AFFICHE_2026_BANDS: Band[] = [
  ...
  },
  {
    name:    'Trifolys',
    jour:    'samedi',
    image:   '/wix/musique/trifolys.webp',
    imageAlt:'Trifolys, photo officielle du groupe',
    bioFR: 'Explorateurs des racines profondes de la musique dans un contexte historique différent et connexe.',
    bioEN: 'Explorers of music’s deepest roots in a different yet adjacent historical context.',
  },
  {
    ...
    imageAlt:'Svarica, photo officielle du groupe',
...
const FR = {
  ...
  title: 'Musique',
  intro1: 'La musique est là derrière le théâtre et le cinéma, autour des ronds de feu, dans les révolutions, et aussi pour mettre de l’ambiance dans votre salon. Ici, nous rendons hommage aux bardes qui animeront cette fin de semaine.',
...
const EN = {
  ...
  title: 'Music',
  intro1: 'Music is there behind theatre and cinema, around fire circles, inside revolutions, and also to set the mood in your living room. Here we honour the bards who will play this weekend.',
