...
const FR = {
  ...
  plans: {
    ...
    comte: {
      ...
      perks: [
        ...
        'Un kiosque à vous sur le site pendant les trois jours, dans le ton médiéval',
        '30 laissez-passer week-end et 2 places au banquet du Prince William',
    ...
    duc: {
      ...
      perks: [
        ...
        '50 laissez-passer week-end, 4 places au banquet et l’accès à l’espace VIP',
  ...
  exclusivity: 'Chaque rang inclut les avantages des rangs précédents. Le titre de Duc est unique : une seule maison le porte par édition. L’édition 2026 est à quelques semaines : une maison qui prend rang maintenant paie la moitié de son rang pour cette première année, et le plein tarif dès la suivante.',
  ...
  plans: {
    ...
    comte: {
      ...
      perks: [
        ...
        'Your own booth on site for the three days, in the medieval spirit',
        '30 weekend passes and 2 seats at the Prince William banquet',
    ...
    duc: {
      ...
      perks: [
        ...
        '50 weekend passes, 4 banquet seats and VIP area access',
        'First right of renewal for the next edition',
      ],
      cta: 'Take the title of Duke', mail: 'Duke of the Festival plan: FMM sponsorship',
    },
  },
  exclusivity: 'Each rank includes the perks of the ranks below. The title of Duke is unique: one house per edition. The 2026 edition is weeks away: a house taking rank now pays half its rank for this first year, and full price from the next one on.',
