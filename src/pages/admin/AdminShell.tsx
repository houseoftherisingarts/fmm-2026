  ...
  return (
    ...
    >
      ...
      {/* On desktop the rail is chrome, not content: it stays put at
          ...
          on a long section. */}
      <aside className={`admin-rail fixed inset-y-0 left-0 z-40 w-72 flex flex-col transform transition-transform duration-300 ${mobileOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 lg:static lg:z-0 lg:sticky lg:top-0 lg:h-screen lg:self-start`}>
        {/* Brand block */}
