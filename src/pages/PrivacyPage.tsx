...
const FR = {
  ...
  section1Body: 'Nous recueillons votre adresse courriel uniquement si vous vous inscrivez à notre infolettre, et des données de navigation anonymisées via Google Analytics, Meta Pixel et notre propre outil de mesure, seulement après votre consentement explicite. Cet outil note les clics et le défilement et rejoue une partie des visites en masquant tout ce qui s\'écrit dans les champs, sans garder aucune adresse IP, et les visites rejouées s\'effacent d\'elles-mêmes après 90 jours.',
...
const EN = {
  ...
  section1Body: 'We collect your email address only if you sign up for our newsletter, and anonymized navigation data via Google Analytics, Meta Pixel and our own measurement tool, only after your explicit consent. That tool notes clicks and scrolling and replays some visits with everything typed into form fields masked out, without keeping any IP address, and replayed visits delete themselves after 90 days.',
