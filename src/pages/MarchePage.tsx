...
const FR: Copy = {
  ...
  market: {
    ...
    yearLabel:   'Édition',
    yearAll:     'Toutes',
    emptyYear:   'Aucun kiosque saisi pour cette édition.',
    photoCaption:'Un kiosque du marché, monté sous la tente.',
  },
  pact: {
    eyebrow:   'Devenir marchand',
    title:     'Votre kiosque sur le marché',
    body:      'La cohorte 2026 est complète et affichée ci-dessus. Les inscriptions 2027 sont ouvertes. Chaque dossier est étudié individuellement : esprit artisanal, ambiance médiévale, conscience écologique.',
    apply2027: 'Postuler 2027',
...
const EN: Copy = {
  ...
  market: {
    ...
    yearLabel:   'Edition',
    yearAll:     'All',
    emptyYear:   'No kiosk recorded for this edition.',
    photoCaption:'A market kiosk, pitched under the canvas.',
  },
  pact: {
    eyebrow:   'Become a merchant',
    title:     'Your kiosk at the market',
    body:      'The 2026 cohort is full and listed above. 2027 applications are open. Each application is reviewed individually: artisan goods, medieval vibe, eco-mindedness.',
    apply2027: 'Apply 2027',
