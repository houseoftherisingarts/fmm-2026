...
const CampagnesSection    = lazy(() => import('./admin/sections/CampagnesSection'));
...
const PlanMarcheSection   = lazy(() => import('./admin/sections/PlanMarcheSection'));
const InventaireSection   = lazy(() => import('./admin/sections/InventaireSection'));
const AffichageSection    = lazy(() => import('./admin/sections/AffichageSection'));
...
const AdminPage: React.FC = () => {
  ...
  const renderSection = () => {
    switch (section) {
      ...
      case 'photosRecues': return <PhotosRecuesSection devBypass={DEV_BYPASS} />;
      case 'campagnes':  return <CampagnesSection />;
      ...
      case 'livraison':  return <LivraisonKiosqueSection />;
      case 'planMarche': return <PlanMarcheSection fetchAll={fetchVendors} />;
  ...
  if (DEV_BYPASS) {
    if (!selectedRole) {
      return (
        <>
          <SEO title="Admin (DEV) · Chambre du Conseil" noindex />
          <GateScreen
            actualRole={null}
            isSuperAdmin
            signedIn
