...
**La compatibilité des formules est le critère d'acceptation du tableur.** Alex, le 2 septembre : « tant que les formules sont les mêmes que sur Google Sheets, ça me va. » Univer annonce 528 fonctions dont la syntaxe est compatible avec Excel, et Google Sheets partage ce même socle : la somme, la condition, la recherche verticale, l'index et l'équivalence, le texte, les dates et les fonctions financières s'écrivent et se comportent de la même façon des deux côtés. Ce qui n'existera pas, ce sont les fonctions propres à Google, celles qu'Excel n'a jamais eues : la formule matricielle automatique, la requête, l'importation d'une plage venue d'un autre classeur, la cotation boursière et le graphique en ligne dans une cellule. La règle de construction qui en découle est simple et elle se vérifie : à l'import d'un classeur, toute formule que le moteur ne connaît pas est NOMMÉE à l'écran, avec sa cellule, plutôt que de rendre une erreur silencieuse dans un coin de la grille. Le banc d'essai de cette étape est l'horaire de Tristan, importé tel quel, dont chaque formule doit rendre le même résultat que dans Google Sheets avant que l'étape soit déclarée finie. Le calcul tourne dans un travailleur de fond, comme Univer le recommande, pour que la grille reste réactive pendant qu'elle recalcule.
