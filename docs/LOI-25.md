...
**La correction.** Repartir du gabarit de la Commission et bâtir la politique sur un tableau de catégories : identification, coordonnées, renseignements techniques, renseignements de santé, renseignements financiers, contenus publiés, communications privées, coordonnées professionnelles de tiers. Pour chaque ligne, dire ce qui est recueilli, à quelle fin, par quel formulaire, qui y a accès dans l'équipe et combien de temps c'est gardé. Ajouter une section sur les destinataires, une sur la sortie hors Québec, une sur les jeunes, une sur les droits, et la date d'entrée en vigueur avec celle de la dernière mise à jour. Retirer le mot « anonymisées ».

La dernière catégorie est arrivée le 2 septembre 2026 avec le bottin des ressources de la régie, et sa ligne du tableau s'écrit ainsi. **Coordonnées professionnelles de tiers** : le nom, la fonction, le téléphone, le courriel et l'adresse de bureau des personnes qui répondent pour la municipalité, la MRC, les services publics, les fournisseurs et l'équipe d'organisation. Recueillies sur les sites officiels de ces organismes ou données par la personne elle-même, jamais auprès d'un tiers. Elles servent à joindre la bonne ressource pendant la préparation et pendant le festival, et à rien d'autre. Elles se saisissent dans la section Bottin et contacts de la régie, jamais par un formulaire public. Elles se lisent et s'écrivent seulement par les adresses inscrites dans `config/equipe-admin.json`, la collection `carnetContacts` étant fermée par `allow read, write: if isAdmin()`. Elles se gardent tant que la ressource sert au festival, et la fiche se supprime quand elle ne sert plus. Le risque tient moins à la nature de ces renseignements, qui sont pour la plupart déjà publiés, qu'aux notes libres que l'équipe y ajoute et à l'allégeance qu'elle attribue à une personne : ces deux champs, eux, n'ont jamais été publics et ne doivent jamais le devenir.
