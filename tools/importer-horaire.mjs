...
const JOURS = [
  ...
  },
  {
    ...
    items: [
      ...
      { time: '10h45–11h45', label: 'Jeu des Chevaliers par l’AMQ',                           where: 'Arène' },
      { time: '10h45–11h30', label: 'Danse aérienne',                                         where: 'Arène' },
      ...
      { time: '12h00–13h00', label: 'Jeu équestre de petit cheval',                           where: 'Arène' },
      { time: '12h30–13h15', label: 'Danse aérienne',                                         where: 'Scène' },
      { time: '12h45–13h30', label: 'Conférence : découverte culturelle, par la Troupe Caravane',   where: 'Village paysan' },
      { time: '12h45–13h30', label: 'Parcours d’herboristerie par Morgane la Sage',           where: 'Camp viking' },
      { time: '13h00–14h00', label: 'Combats vikings',                                        where: 'Arène' },
      { time: '14h00–14h30', label: 'Démonstration de forge',                                 where: 'Village paysan' },
      { time: '14h30–15h30', label: 'Joute de petit cheval',                                  where: 'Arène' },
  ...
  },
  {
    ...
    items: [
      ...
      { time: '13h00–14h00', label: 'Conférence : découverte culturelle, par la Troupe Caravane', where: 'Village paysan' },
      { time: '13h00–14h00', label: 'Tournoi de « boat fight » : combat viking',              where: 'Arène' },
      { time: '13h30–15h00', label: 'Banquet du Prince William',                                  where: 'Village Nourriture' },
